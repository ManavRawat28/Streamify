...
try {
   ...
   await User.findByIdAndUpdate(
        ...
        {$addToSet:{friends:friendRequest.sender}}, // $addToSet ensures no duplicates
    );
...
export async function getFriendRequests(req, res) {
  try {
     const imcomingReqs = await FriendRequest.find({
      recipient: req.user.id,
      status: 'pending'
    }).poppulate('sender', 'fullName profilePic nativeLanguage learningLanguage');
